...
public class GeoStringUtils {
	...
	public static Map<String, String> spilitToMap(String ItemSpiltFlag,
		...
		while (stringTokenizer.hasMoreTokens()) {
			...
			if (keyValue.length >= 2) {
				...
				//System.err.println(keyValue[0].trim().toLowerCase());
			}
		}
	...
	public static void main(String[] args) {
		...
		GeoStringUtils.spilitToMap(";", "=", "123=456; 456=123");
		GeoStringUtils.spilitToMap(";?", "=",
				"/dfsdf/dfjasdjfkldjasfj?123=2222;dsfasdfdas=fdasf;");
		GeoStringUtils
				.spilitToMap(";?", "=",
						"http://www.baidu.com/dfsdf/dfjasdjfkldjasfj?123=2222;dsfasdfdas=fdasf;");
	}
